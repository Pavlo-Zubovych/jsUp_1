...
const city = 'Zhytomyr';
const inCountry = 'Ukraine';
let population = 261600;
let stadiumInCity = true;
...
const distanceOfFirst = speedOfFirst * time;
const distanceOfSecond = speedOfSecond * time;

const distanceBetweenCities = distanceOfFirst + distanceOfSecond;
